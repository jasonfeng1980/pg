...
func (k *Key) Exists() (int64 ,error){
    return k.Client.Exists(k.CTX, k.Name).Result()
}
// 为给定 key 设置过期时间，以秒计。
func (k *Key) Expire() (bool, error){
    return k.Client.Expire(k.CTX, k.Name, k.Expr).Result()
}
// ExpireAt 的作用和 EXPIRE 类似，都用于为 key 设置过期时间。 不同在于 ExpireAt 命令接受的时间参数是 UNIX 时间戳(unix timestamp)。
func (k *Key) ExpireAt(tm time.Time) (bool, error){
    return k.Client.ExpireAt(k.CTX, k.Name, tm).Result()
}
// 设置 key 的过期时间以毫秒计。
func (k *Key) PExpire() (bool, error){
    return k.Client.PExpire(k.CTX, k.Name, k.Expr).Result()
}
// 设置 key 过期时间的时间戳(unix timestamp) 以毫秒计
func (k *Key) PExpireAt(tm time.Time) (bool, error){
    return k.Client.PExpireAt(k.CTX, k.Name, tm).Result()
}
// 将当前数据库的 key 移动到给定的数据库 db 当中。
func (k *Key) Move(db int) (bool, error){
    return k.Client.Move(k.CTX, k.Name, db).Result()
}
// 该命令用于在 key 存在时删除 key。
func (k *Key) Del() (int64 ,error){
    return k.Client.Del(k.CTX, k.Name).Result()
}
...
func (s *String) Set(value interface{}) (string ,error){
    return s.Client.Set(s.CTX, s.Name, value, s.Expr).Result()
}
// 只有在 key 不存在时设置 key 的值。
func (s *String) SetNX(value interface{}) (bool, error){
    return s.Client.SetNX(s.CTX, s.Name, value, s.Expr).Result()
}
// 对 key 所储存的字符串值，设置或清除指定偏移量上的位(bit)
func (s *String) SetBit(offset int64, value int) (int64 ,error){
    return s.Client.SetBit(s.CTX, s.Name, offset, value).Result()
}
// 用 value 参数覆写给定 key 所储存的字符串值，从偏移量 offset 开始。
func (s *String) SetRange(offset int64, value string) (int64 ,error){
    return s.Client.SetRange(s.CTX, s.Name, offset, value).Result()
}
// 获取指定 key 的值
func (s *String) Get() (string ,error){
    return s.Client.Get(s.CTX, s.Name).Result()
}
// 将给定 key 的值设为 value ，并返回 key 的旧值(old value)。
func (s *String) GetSet(value interface{}) (string ,error){
    return s.Client.GetSet(s.CTX, s.Name, value).Result()
}
// 返回 key 中字符串值的子字符
func (s *String) GetRange(start, end int64) (string ,error){
    return s.Client.GetRange(s.CTX, s.Name, start, end).Result()
}
// 对 key 所储存的字符串值，获取指定偏移量上的位(bit)。
func (s *String) GetBit(offset int64) (int64 ,error){
    return s.Client.GetBit(s.CTX, s.Name, offset).Result()
}
// 返回 key 所储存的字符串值的长度。
func (s *String) StrLen() (int64 ,error){
    return s.Client.StrLen(s.CTX, s.Name).Result()
}
// 将 key 中储存的数字值增一。
func (s *String) Incr() (int64 ,error){
    return s.Client.Incr(s.CTX, s.Name).Result()
}
// 将 key 所储存的值加上给定的增量值（increment） 。
func (s *String) IncrBy(increment int64) (int64 ,error){
    return s.Client.IncrBy(s.CTX, s.Name, increment).Result()
}
// 将 key 所储存的值加上给定的浮点增量值（increment） 。
func (s *String) IncrByFloat(increment float64) (float64 ,error){
    return s.Client.IncrByFloat(s.CTX, s.Name, increment).Result()
}
// 将 key 中储存的数字值减一。
func (s *String) Decr() (int64 ,error){
    return s.Client.Decr(s.CTX, s.Name).Result()
}
// key 所储存的值减去给定的减量值（decrement） 。
func (s *String) DecrBy(increment int64) (int64 ,error){
    return s.Client.DecrBy(s.CTX, s.Name, increment).Result()
}
// 如果 key 已经存在并且是一个字符串， APPEND 命令将指定的 value 追加到该 key 原来值（value）的末尾。
func (s *String) Append(value string) (int64 ,error){
    return s.Client.Append(s.CTX, s.Name, value).Result()
}
...
func (h *Hash) HDel(field string) (int64 ,error){
    return h.Client.HDel(h.CTX, h.Name, field).Result()
}
...
func (h *Hash) HGetField() (string ,error){
    return h.Client.HGet(h.CTX, h.Name, h.Field).Result()
}
// 获取在哈希表中指定 key 的所有字段和值
func (h *Hash) HGetAll() (map[string]string, error){
    return h.Client.HGetAll(h.CTX, h.Name).Result()
}
// 为哈希表 key 中的指定字段的整数值加上增量 increment 。
func (h *Hash) HIncrBy(field string, incr int64) (int64 ,error){
    return h.Client.HIncrBy(h.CTX, h.Name, field, incr).Result()
}
// 为哈希表 key 中的指定字段的浮点数值加上增量 increment 。
func (h *Hash) HIncrByFloat(field string, incr float64) (float64 ,error){
    return h.Client.HIncrByFloat(h.CTX, h.Name, field, incr).Result()
}
// 获取所有哈希表中的字段。
func (h *Hash) HKeys() ([]string ,error){
    return h.Client.HKeys(h.CTX, h.Name).Result()
}
// 获取哈希表中所有值。
func (h *Hash) HVals() ([]string ,error){
    return h.Client.HVals(h.CTX, h.Name).Result()
}
// 获取哈希表中字段的数量
func (h *Hash) HLen() (int64 ,error){
    return h.Client.HLen(h.CTX, h.Name).Result()
}
// 获取所有给定字段的值
func (h *Hash) HMGet(fields ...string) ([]interface{}, error){
    return h.Client.HMGet(h.CTX, h.Name, fields...).Result()
}
...
func (h *Hash) HSetField(value interface{}) (int64 ,error){
    return h.Client.HSet(h.CTX, h.Name, h.Field, value).Result()
}
// 同 HSet
// HMSet 支持一下的形式:
...
func (h *Hash) HMSet(values ...interface{}) (bool, error){
    return h.Client.HMSet(h.CTX, h.Name, values...).Result()
}
// 只有在字段 field 不存在时，设置哈希表字段的值。
// 单个添加
func (h *Hash) HSetNX(field string, value interface{}) (bool, error){
    return h.Client.HSetNX(h.CTX, h.Name, field, value).Result()
}
// 迭代哈希表中的键值对。
// - cursor - 游标。
// - match - 匹配的模式。
...
func (h *Hash) HScan(cursor uint64, match string, count int64) ([]string, uint64, error){
    return h.Client.HScan(h.CTX, h.Name, cursor, match, count).Result()
}
//////////////////////////////////////////////
//
//  Redis-list
...
func (l *List) BRPopLPush(source, destination string, timeout time.Duration) (string ,error){
    return l.Client.BRPopLPush(l.CTX, source, destination, timeout).Result()
}
// 通过索引获取列表中的元素
func (l *List) LIndex(index int64) (string ,error){
    return l.Client.LIndex(l.CTX, l.Name, index).Result()
}
// 在列表的元素前或者后插入元素
// - op  = before  ||  after
// - pivot 什么值
func (l *List) LInsert(op string, pivot, value interface{}) (int64 ,error){
    return l.Client.LInsert(l.CTX, l.Name, op, pivot, value).Result()
}
// 获取列表长度
func (l *List) LLen() (int64 ,error){
    return l.Client.LLen(l.CTX, l.Name).Result()
}
// 移出并获取列表的第一个元素
func (l *List) LPop() (string ,error){
    return l.Client.LPop(l.CTX, l.Name).Result()
}
// 将一个或多个值插入到列表头部
func (l *List) LPush(values ...interface{}) (int64 ,error){
    return l.Client.LPush(l.CTX, l.Name, values...).Result()
}
// 将一个值插入到【已存在】的列表头部
func (l *List) LPushX(values ...interface{}) (int64 ,error){
    return l.Client.LPushX(l.CTX, l.Name, values...).Result()
}
// 获取列表指定范围内的元素
func (l *List) LRange(start, stop int64) ([]string ,error){
    return l.Client.LRange(l.CTX, l.Name, start, stop).Result()
}
// 移除列表 count个 等于value 的元素
func (l *List) LRem(count int64, value interface{}) (int64 ,error){
    return l.Client.LRem(l.CTX, l.Name, count, value).Result()
}
// 通过索引设置列表元素的值
func (l *List) LSet(index int64, value interface{}) (string ,error){
    return l.Client.LSet(l.CTX, l.Name, index, value).Result()
}
// 对一个列表进行修剪(trim)，就是说，让列表只保留指定区间内的元素，不在指定区间之内的元素都将被删除。
func (l *List) LTrim(start, stop int64) (string ,error){
    return l.Client.LTrim(l.CTX, l.Name, start, stop).Result()
}
// 移除列表的最后一个元素，返回值为移除的元素。
func (l *List) RPop() (string ,error){
    return l.Client.RPop(l.CTX, l.Name).Result()
}
// 移除列表的最后一个元素，并将该元素添加到另一个列表并返回
func (l *List) RPopLPush(source, destination string) (string ,error){
    return l.Client.RPopLPush(l.CTX, source, destination).Result()
}
// 在列表中添加一个或多个值
func (l *List) RPush(value ...interface{}) (int64 ,error){
    return l.Client.RPush(l.CTX, l.Name, value...).Result()
}
// 为【已存在】的列表添加值
func (l *List) RPushX(value ...interface{}) (int64 ,error){
    return l.Client.RPushX(l.CTX, l.Name, value...).Result()
}
...
func (s *Set)SAdd(members ...interface{}) (int64 ,error){
    return s.Client.SAdd(s.CTX, s.Name, members...).Result()
}
// 获取集合的成员数
func (s *Set)SCard() (int64 ,error){
    return s.Client.SCard(s.CTX, s.Name).Result()
}
// 返回第一个集合与其他集合之间的差异。
...
func (s *Set)SDiffStore(destination string, keys ...string) (int64 ,error){
    return s.Client.SDiffStore(s.CTX, destination, keys...).Result()
}
// 返回给定所有集合的交集
...
func (s *Set)SInterStore(destination string, keys ...string) (int64 ,error){
    return s.Client.SInterStore(s.CTX, destination, keys...).Result()
}
// 判断 member 元素是否是集合 key 的成员
func (s *Set)SIsMember(member interface{}) (bool, error){
    return s.Client.SIsMember(s.CTX, s.Name, member).Result()
}
// 返回集合中的所有成员
// Redis `SMEMBERS key` command output as a slice.
func (s *Set)SMembers() ([]string ,error){
    return s.Client.SMembers(s.CTX, s.Name).Result()
}
// 返回集合中的所有成员
// Redis `SMEMBERS key` command output as a map.
func (s *Set)SMembersMap() (map[string]struct{}, error){
    return s.Client.SMembersMap(s.CTX, s.Name).Result()
}
// 将 member 元素从 source 集合移动到 destination 集合
func (s *Set)SMove(destination string, member interface{}) (bool, error){
    return s.Client.SMove(s.CTX, s.Name, destination, member).Result()
}
// 移除并返回集合中的1个随机元素
func (s *Set)SPop() (string ,error){
    return s.Client.SPop(s.CTX, s.Name).Result()
}
// 移除并返回集合中的多个随机元素
func (s *Set)SPopN(count int64) ([]string ,error){
    return s.Client.SPopN(s.CTX, s.Name, count).Result()
}
// 返回集合中一个随机数
func (s *Set)SRandMember() (string ,error){
    return s.Client.SRandMember(s.CTX, s.Name).Result()
}
// 返回集合中多个随机数
func (s *Set)SRandMemberN(count int64) ([]string ,error){
    return s.Client.SRandMemberN(s.CTX, s.Name, count).Result()
}
// 移除集合中一个或多个成员
func (s *Set)SRem(members ...interface{}) (int64 ,error){
    return s.Client.SRem(s.CTX, s.Name, members...).Result()
}
// 返回所有给定集合的并集
...
func (s *Set)SUnionStore(keys ...string) (int64 ,error){
    return s.Client.SUnionStore(s.CTX, s.Name, keys...).Result()
}
// 迭代集合中的元素
// - cursor - 游标。
// - match - 匹配的模式。
...
func (s *Set) SScan(cursor uint64, match string, count int64) ([]string, uint64, error){
    return s.Client.SScan(s.CTX, s.Name, cursor, match, count).Result()
}
...
func (z *ZSet) ZAdd(nxOrXx string ,returnCh bool, members ...*redis.Z) (int64 ,error){
    if returnCh {
        switch nxOrXx {
        case "nx":
            return z.Client.ZAddNXCh(z.CTX, z.Name, members...).Result()
        case "xx":
            return z.Client.ZAddXXCh(z.CTX, z.Name, members...).Result()
        default:
            return z.Client.ZAddCh(z.CTX, z.Name, members...).Result()
        }
    } else {
        switch nxOrXx {
        case "nx":
            return z.Client.ZAddNX(z.CTX, z.Name, members...).Result()
        case "xx":
            return z.Client.ZAddXX(z.CTX, z.Name, members...).Result()
        default:
            return z.Client.ZAdd(z.CTX, z.Name, members...).Result()
        }
    }
}
...
func (z *ZSet) ZIncr(nxOrXx string , members *redis.Z) (float64 ,error){
    switch nxOrXx {
    case "nx":
        return z.Client.ZIncrNX(z.CTX, z.Name, members).Result()
    case "xx":
        return z.Client.ZIncrXX(z.CTX, z.Name, members).Result()
    default:
        return z.Client.ZIncr(z.CTX, z.Name, members).Result()
    }
}
// 获取有序集合的成员数
func (z *ZSet) ZCard() (int64 ,error){
    return z.Client.ZCard(z.CTX, z.Name).Result()
}
// 计算在有序集合中指定区间分数的成员数
func (z *ZSet) ZCount(min, max string) (int64 ,error){
    return z.Client.ZCount(z.CTX, z.Name, min, max).Result()
}
// 计算有序集合中指定字典区间内成员数量。
func (z *ZSet) ZLexCount(min, max string) (int64 ,error){
    return z.Client.ZLexCount(z.CTX, z.Name, min, max).Result()
}
// 有序集合中对指定成员的分数加上增量 increment
func (z *ZSet) ZIncrBy(increment float64, member string) (float64 ,error){
    return z.Client.ZIncrBy(z.CTX, z.Name, increment, member).Result()
}
// 计算给定的一个或多个有序集的交集,并将结果集存储在新的有序集合 destination 中 (member合并，score相加)
func (z *ZSet) ZInterStore(store *redis.ZStore) (int64 ,error){
    return z.Client.ZInterStore(z.CTX, z.Name, store).Result()
}
// 删除并返回有序集合key中的最多count个具有【最高得分】的成员。
func (z *ZSet) ZPopMax(count ...int64) ([]redis.Z, error){
    return z.Client.ZPopMax(z.CTX, z.Name, count...).Result()
}
// 删除并返回有序集合key中的最多count个具有【最低得分】的成员。
func (z *ZSet) ZPopMin(count ...int64) ([]redis.Z, error){
    return z.Client.ZPopMin(z.CTX, z.Name, count...).Result()
}
...
func (z *ZSet) ZScan(cursor uint64, match string, count int64) ([]string, uint64, error){
    return z.Client.ZScan(z.CTX, z.Name, cursor, match, count).Result()
}
...
func (g *GEO) GeoRadiusStore(longitude, latitude float64, query *redis.GeoRadiusQuery) (int64 ,error){
    return g.Client.GeoRadiusStore(g.CTX, g.Name, longitude, latitude, query).Result()
}
...
func (g *GEO) GeoRadiusByMember(member string, query *redis.GeoRadiusQuery) ([]redis.GeoLocation ,error){
    return g.Client.GeoRadiusByMember(g.CTX, g.Name, member, query).Result()
}
// 根据储存在位置集合里面的某个地点获取指定范围内的地理位置集合。
// GeoRadiusByMemberStore is a writing GEORADIUSBYMEMBER command.
func (g *GEO) GeoRadiusByMemberStore(member string, query *redis.GeoRadiusQuery) (int64 ,error){
    return g.Client.GeoRadiusByMemberStore(g.CTX, g.Name, member, query).Result()
}
// 返回两个给定位置之间的距离。
// - unint:   m | km | mi | ft
func (g *GEO) GeoDist(member1 string, member2 string, unint string) (float64 ,error){
    return g.Client.GeoDist(g.CTX, g.Name, member1, member2, unint).Result()
}
// 用于获取多个位置元素的 geohash 值
func (g *GEO) GeoHash(member ...string) ([]string ,error){
    return g.Client.GeoHash(g.CTX, g.Name, member...).Result()
}
